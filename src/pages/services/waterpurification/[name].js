...
function Index() {
  ...
  const type = router.query.name;
   let nameType = "";
  if (type === "DrinkingWaterPurification") {
    nameType = "تصفیه آب آشامیدنی";
  }
   if (type === "IndustrialWaterTreatment") {
    nameType = "تصفیه آب های صنعتی";
  }
  return (
    <div>
      ...
      {type === "IndustrialWaterTreatment" && (
        <div className={styles.picbackg}>
          ...
          <div className={styles.textServices}>
            ...
            <p>
              شرکت مهندسی دزون بهترین راه حل های قابل دسترس برای تصفیه آب های
              صنعتی با بالاترین کیفیت را ارائه می دهد.
            </p>
