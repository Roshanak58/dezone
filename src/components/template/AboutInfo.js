...
function AboutInfo({ type }) {
  let nameType = "";
  if (type === "info") {
    nameType = "اطلاعات کلی و حقوقی شرکت مهندسی دزون";
  }
  if (type === "QC") {
    nameType = "خط مشی کیفی";
  }
  if (type === "ranking") {
    nameType = " رتبه بندی صلاحیت های شرکت مهندسی دزون";
  }
  if (type === "activity") {
    nameType = "  موضوع فعالیت شرکت ";
  }
  if (type === "Qualification") {
    nameType = " گواهی صلاحیت پیمانکاری";
  }
  return (
    <>
          ...
          <div>
            ...
            <div className={styles.gridLi}>
              ...
              <ul>
                ...
                <li>سرمایه ثبت شده: 428000000000 ريال</li>
                <li>سرمایه پرداخت شده: 428000000000 ريال</li>
              </ul>
            </div>
          </div>
        )}
        {type === "QC" && (
          <div>
            {/* <Image
              ...
              className={styles.smallImage}
            /> */}
            {/* <h3 className={styles.aboutH3}> </h3> */}
            <p></p>
            <p className={styles.textClass}>
              ...
              پاسخگویی به نیازهای مشتریان خواهد بود. هدف ما، ارائه به موقع، دقیق
              و کامل خدمات مورد نیاز براساس نیازهای واقعی مشتریان است.
            </p>
          </div>
        )}
        {type === "ranking" && (
        ...
        {type === "activity" && (
          <div>
            ...
            <p className={styles.textClass}>
              ...
              سازی، ارائه طرح و مشاوره و اجرا در زمینه نصب و راه اندازی تاسیسات
              و تجهیزات شامل تصفیه، انتقال و توزیع آب، جمع آوری، تصفیه و دفع
              فاضلاب، اخذ نمایندگی از داخل و خارج کشور و صادرات و واردات کلیه
              کالاهای مجاز بازرگانی{" "}
            </p>
          </div>
        )}
        {type === "Qualification" && (
